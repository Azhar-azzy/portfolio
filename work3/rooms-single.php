...
<!-- 		<div class="hero-wrap" style="background-image: url('images/bg_1.jpg');height: 300px;">
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex  justify-content-center">
        ...
        <div class="row pt-5">
          <div class="col-lg-8">
          	<div class="row">
          		...
          		<div class="col-md-12 rooms-single mt-4 mb-5 ftco-animate">
          		...
          		<div class="col-md-12 rooms-single ftco-animate mb-5 mt-4">
