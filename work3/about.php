      ...
      <div class="container-fluid">
        ...
        <div class="row no-gutters">
          <div class="col-sm-12 col-md ftco-animate">
            <a href="images/sea1.jpg" class="insta-img image-popup" style="background-image: url(images/sea1.jpg);">
          ...
          <div class="col-sm-12 col-md ftco-animate">
            <a href="images/sea2.jpg" class="insta-img image-popup" style="background-image: url(images/sea2.jpg);">
              <div class="icon d-flex justify-content-center">
                <span class="icon-instagram align-self-center"></span>
              </div>
            </a>
          ...
          <div class="col-sm-12 col-md ftco-animate">
            <a href="images/event1.jpg" class="insta-img image-popup" style="background-image: url(images/event1.jpg);">
              <div class="icon d-flex justify-content-center">
                <span class="icon-instagram align-self-center"></span>
              </div>
            </a>
          ...
          <div class="col-sm-12 col-md ftco-animate">
            <a href="images/event2.jpg" class="insta-img image-popup" style="background-image: url(images/event2.jpg);">
              <div class="icon d-flex justify-content-center">
                <span class="icon-instagram align-self-center"></span>
              </div>
            </a>
          ...
          <div class="col-sm-12 col-md ftco-animate">
            <a href="images/sea3.jpg" class="insta-img image-popup" style="background-image: url(images/sea3.jpg);">
              <div class="icon d-flex justify-content-center">
                <span class="icon-instagram align-self-center"></span>
              </div>
            </a>
